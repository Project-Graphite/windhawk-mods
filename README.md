...
controls in the Windows 11 taskbar, including a context-menu entry that opens the playing app or
starts Spotify, per-app volume, audio-only app support, session switching, Fluent backgrounds,
multi-monitor placement, and an optional spectrum visualizer.
